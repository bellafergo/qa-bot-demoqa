...
class Settings:
    ...
    SSO_MICROSOFT_CLIENT_SECRET: str = (os.getenv("SSO_MICROSOFT_CLIENT_SECRET") or "").strip()
    SSO_GOOGLE_CLIENT_ID: str = (os.getenv("SSO_GOOGLE_CLIENT_ID") or "").strip()
    SSO_GOOGLE_CLIENT_SECRET: str = (os.getenv("SSO_GOOGLE_CLIENT_SECRET") or "").strip()
    SSO_OKTA_CLIENT_ID: str = (os.getenv("SSO_OKTA_CLIENT_ID") or "").strip()
    SSO_OKTA_CLIENT_SECRET: str = (os.getenv("SSO_OKTA_CLIENT_SECRET") or "").strip()
