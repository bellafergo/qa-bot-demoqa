            ...
            + [
                {
                    ...
                    "content": (
                        ...
                        "CRITICAL — USER LITERALS: When the user provides exact values to type or use "
                        "(emails, passwords, URLs, usernames, names, IDs, tokens, codes, or any literal string), "
                        "copy them EXACTLY as provided, character by character. Do not paraphrase, normalize, "
                        "correct, infer, autocomplete, or alter them. Preserve @, dots, hyphens, underscores, "
                        "and every character of domains and paths exactly as written.\n"
